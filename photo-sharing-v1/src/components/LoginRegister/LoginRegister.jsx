  ...
  const handleSubmitRegister = () => {
    ...
    createUser(registerReq)
      ...
      .catch((err) => {
        console.log("err: ", err);
        setErrorRegister(
          err.response.data.msg || err.response.data || "Please check backend"
        );
      });
  };
  ...
  return (
    <div className="row">
      ...
      <div className="col-8 d-flex justify-content-center align-items-center flex-column">
        ...
        <button onClick={handleSubmitRegister} className="btn btn-primary mt-2">
          Register me
        </button>
      </div>
    </div>
